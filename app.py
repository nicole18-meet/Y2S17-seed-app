...
def create_routine():
	...
	shoot_1  = Shoot(title="", taken_time=datetime.datetime(t.year, t.month, t.day, 8, 0))
	...
	shoot_4  = Shoot(taken_time=datetime.datetime(t.year, t.month, t.day, 9, 0))
	shoot_5  = Shoot(taken_time=datetime.datetime(t.year, t.month, t.day, 9, 0))
	shoot_6  = Shoot(taken_time=datetime.datetime(t.year, t.month, t.day, 9, 0))
	shoot_7  = Shoot(taken_time=datetime.datetime(t.year, t.month, t.day, 9, 0))
	shoot_8  = Shoot(taken_time=datetime.datetime(t.year, t.month, t.day, 9, 0))
	shoot_9  = Shoot(taken_time=datetime.datetime(t.year, t.month, t.day, 9, 0))
	shoot_10 = Shoot(taken_time=datetime.datetime(t.year, t.month, t.day, 9, 0))
	shoot_11 = Shoot(taken_time=datetime.datetime(t.year, t.month, t.day, 9, 0))
	shoot_12 = Shoot(taken_time=datetime.datetime(t.year, t.month, t.day, 9, 0))
	shoot_13 = Shoot(taken_time=datetime.datetime(t.year, t.month, t.day, 9, 0))
	shoot_14 = Shoot(taken_time=datetime.datetime(t.year, t.month, t.day, 9, 0))
